...
if LocalPlayer():GTeam() != TEAM_SPEC then
	...
	local faction_table = {
		...
		[ 8 ] = { name = clang.OSN, icon = "nextoren/gui/roles_icon_new/mtf_hammer.png", roles = BREACH_ROLES.OSN, Desc = "l:f2_osn" },
		[ 9 ] = { name = clang.Chaos, icon = "nextoren/gui/roles_icon/chaos.png", roles = BREACH_ROLES.CHAOS, Desc = "l:f2_chaos" },
		[ 10 ] = { name = clang.Goc, icon = "nextoren/gui/roles_icon/goc.png", roles = BREACH_ROLES.GOC, Desc = "l:f2_goc" },
		[ 11 ] = { name = clang.Goc_Contaiments, icon = "nextoren/gui/roles_icon/goc2.png", roles = BREACH_ROLES.GOC_CONTAIMENTS, Desc = "l:f2_goc_containments" },
		[ 12 ] = { name = clang.Cult, icon = "nextoren/gui/roles_icon/scarlet.png", roles = BREACH_ROLES.COTSK, Desc = "l:f2_cult" },
		[ 13 ] = { name = clang.UIU, icon = "nextoren/gui/roles_icon/fbi.png", roles = BREACH_ROLES.FBI, Desc = "l:f2_uiu" },
		[ 14 ] = { name = clang.UIU, icon = "nextoren/gui/roles_icon/fbi_agent.png", roles = BREACH_ROLES.FBI_AGENTS, Desc = "l:f2_uiu_agent" },
		[ 15 ] = { name = clang.DZ, icon = "nextoren/gui/roles_icon/dz.png", class_d = "敌人", roles = BREACH_ROLES.DZ, Desc = "l:f2_dz" },
		[ 16 ] = { name = "SCP", icon = "nextoren/gui/roles_icon/scp.png", roles = BREACH_ROLES.SCP, Desc = "l:f2_scp" },
	}
	...
	BREACH.NameFac.Paint = function( self, w, h )
	  ...
	  draw.DrawText( "阵营", "ChatFont_new", w / 2, h / 2 - 16, color_black, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
					...
					for i,cls in ipairs(v.roles) do
						...
						BREACH.FactionInformation.Roles.FaceModel.Closed.DoClick = function()
							...
							local roles_icons = Material("nextoren/gui/roles_icon/scp.png")
								...
								elseif cls["team"] == TEAM_GOC_CONTAIN then
									roles_icons = Material("nextoren/gui/roles_icon/goc2.png")
								...
								elseif cls["team"] == TEAM_OSN then
									roles_icons = Material("nextoren/gui/roles_icon_new/mtf_hammer.png")
