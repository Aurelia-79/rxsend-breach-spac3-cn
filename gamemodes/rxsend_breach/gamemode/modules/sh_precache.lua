...
if SERVER then
  hook.Add("InitPostEntity", "Breach:PrecacheResources", function()
    -- Do not recursively precache every Workshop model on startup. GMod loads
    -- models when entities use them, while this scan also loads broken assets.
    print("[RXSEND] Skipping full Workshop model precache")
  end)
end