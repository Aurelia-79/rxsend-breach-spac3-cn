...
function ulx.getpenalty( admin, ply )
	...
	admin:RXSENDNotify("所需逃脱次数：",Color(255,0,0), ply:GetPenaltyAmount())
...
function ulx.checkpenalty( me )
	...
	if amount > 0 then
		...
		me:RXSENDNotify("所需逃脱次数：",Color(255,0,0), amount)

	else

		me:RXSENDNotify("你没有受罚者状态。")
...
forcesupport:addParam{ type=ULib.cmds.StringArg, hint="supportname", completes = {"GRU", "COTSK", "FBI", "CHAOS", "NTF", "GOC", "DZ", "OSN"} }
