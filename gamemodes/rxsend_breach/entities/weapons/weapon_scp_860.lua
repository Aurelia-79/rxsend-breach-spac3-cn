SWEP.AbilityIcons = {

  {
    ...
    Name = "利爪",
    Description = "利爪攻击，造成目标最大生命值45%的伤害",
    Cooldown = 0.75,
    CooldownTime = 0,
    KEY = "LMB",
    Icon = "abils/860_claws.png"
...

  {
    ...
    Name = "猎手直觉",
    Description = "10秒内可以透视所有玩家，且脚步声消失",
    Cooldown = 60,
    CooldownTime = 0,
    KEY = "RMB",
    Icon = "abils/860_sense.png"
...

  {
    ...
    Name = "冲刺",
    Description = "冲刺9秒，期间只能使用'传送'能力",
    Cooldown = 45,
    CooldownTime = 0,
    KEY = _G["KEY_LSHIFT"],
    Icon = "abils/860_sprint.png"
...

  {
    ...
    Name = "传送",
    Description = "将你和你抓住的人传送到你的森林。",
    Cooldown = 85,
    CooldownTime = 0,
    KEY = _G["KEY_F"],
    Icon = "abils/860_shift.png"
...
local victim_teleport = Vector(14504.359375, -11216.834961, -3396.027588)
local teleport_860 = Vector(10766.436523, -11217.120117, -3396.127441)
