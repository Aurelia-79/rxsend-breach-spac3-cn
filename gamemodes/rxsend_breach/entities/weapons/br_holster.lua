...
SWEP.PrintName = "徒手" -- (String) Printed name on menu
...
function SWEP:PrimaryAttack( right )
	...
	if IsValid(HitEnt) and HitEnt:GetClass() == "item_special_document" and self.Owner:GetRoleName() != role.SCI_SpyUSA then
		return
	end
